...
$(document).on('click','#filter_forum',function(){
    ...
    var type = $('.filter_form #type').val();
    fromDate = startDate.format('YYYY-MM-DD');
    toDate = endDate.format('YYYY-MM-DD');
    DatatableInitiate(status,fromDate,toDate,createdBy,type);
});
...
function DatatableInitiate(status='',fromDate='',toDate='',createdBy='',type='') {
    $("#Tdatatable").DataTable({
        language: {
            searchPlaceholder:
                "Song,Artist,Customer,Email,Ratings,Created at...",
        },
        bDestroy: true,
        processing: true,
        serverSide: true,
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    if (data == 1) {
                        return (
                            '<span style="color: red"><i class="fas fa-star"></i>\n' +
                            "\n</span>" +
                            '<span style="color: grey"><i class="fas fa-star"></i>\n' +
                        ...
                        return (
                            '<span style="color: orange"><i class="fas fa-star"></i>\n' +
                            '\n<i class="fas fa-star"></i>\n' +
                            '\n<i class="fas fa-star"></i>\n' +
                            "\n</span>" +
                            '<span style="color: grey"><i class="fas fa-star"></i>\n' +
                        ...
                        return (
                            '<span style="color: green"><i class="fas fa-star"></i>\n' +
                            '\n<i class="fas fa-star"></i>\n' +
                            '\n<i class="fas fa-star"></i>\n' +
                            '\n<i class="fas fa-star"></i>\n' +
                            "\n</span>" +
