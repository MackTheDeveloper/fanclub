...
@section('content')
    ...
    <div class="edit-profile">
        ...
        <form action="{{ url('updateArtistProfile') }}" id="updateArtist" name="registration" method="POST"
            ...
            <div class="profile-content">
                ...
                {{-- <p class="blur-color">Introducer - Kaiya Stanton</p> --}}
                @csrf
                <div>
                    <div class="inputs-group">
                        <input type="text" name="firstname" value="{{ $profileData->firstName . $profileData->lastName }}">
                        <span>Your name*</span>
                    ...
                    <div class="inputs-group">
                        <input type="email" name="email" readonly required value="{{ $profileData->email }}">
                    ...
                    <div class="gender">
                        ...
                        @foreach ($profileData->gender as $key => $row)
                            <label class="rd">{{ $row->value }}
                                <input name="gender" type="radio" {{ $row->selected == '1' ? 'checked' : '' }}
                                    class="introduce-radio" value="{{ $row->key }}" name="gender">
