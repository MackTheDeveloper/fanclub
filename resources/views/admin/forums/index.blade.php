...
<title>{{config('app.name_show')}} | Forums </title>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">Forums</span>
                                </div>
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="javascript:void(0);" style="color: grey">Forums</a>
                                            </li>
...
<script>
    ...
    $('#searchableFormListing').attr('action', base_url + '/securefcbcontrol/forums/index');
    if (window.history.replaceState) {
        window.history.replaceState(null, null, window.location.href);
    }
</script>
<script src="{{asset('public/assets/js/forums/forums.js')}}"></script>
<script>
