...
<title>{{config('app.name_show')}} | Transaction </title>
...
<div class="app-main">
    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                            ...
                            <div class="page-title-subheading opacity-10">
                                <nav class="" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="javascript:void(0);" style="color: grey">Transactions</a>
                                        </li>
            ...
            @endif --}}
            <div class="page-title-actions">
                @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_transaction_export') === true)
                ...
                {{ Form::open(array('url' => route('exportTransaction'),'class'=>'exportSub','id'=>'exportTransaction','autocomplete'=>'off')) }}
        ...
        <div class="card-body">
            ...
            <div>
                <form method="post" class="form-inline">
                    ...
                    <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                        <label for="plan" class="mr-sm-2">Plan</label>
...
<script>
    ...
    $('#searchableFormListing').attr('action', base_url + '/securefcbcontrol/transaction/index');
    if (window.history.replaceState) {
        window.history.replaceState(null, null, window.location.href);
    }
</script>
<script src="{{asset('public/assets/js/transaction/transaction.js?t=20220811')}}"></script>
<script>
