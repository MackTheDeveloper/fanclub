...
<title>{{config('app.name_show')}} | fanclub Playlists </title>
            ...
            <div class="app-main__inner">
                <div class="app-page-title app-page-title-simple">
                    <div class="page-title-wrapper">
                        ...
                        @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_playlist_add') === true)

                            <div class="d-inline-block dropdown" >
                                <a href="{{url(config('app.adminPrefix').'/playlists/create')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add</button></a>
                            </div>
