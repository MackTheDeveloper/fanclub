...
@push('styles')
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/custom/star-rating/css/star-rating.css')}}">
<style>
    .hide_column {
        display: none;
    }
                ...
                <div class="main-card mb-3 card expand_filter" style="display:none;">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                <label for="product_id" class="mr-sm-2">Products</label>
                                <?php echo Form::select('product_id', $products, '', ['class' => 'form-control ', 'placeholder' => 'Select Product', 'id' => 'product_id']); ?>
                            </div>
                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                <label for="status" class="mr-sm-2">Status</label>
                                <select name="status" id="status" class="form-control col-7">
                            ...
                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                <label for="ratings" class="mr-sm-2">Ratings</label>
                                <select name="ratings" id="ratings" class="form-control col-6">
                                    <option value="">All</option>
...
@section('modals-content')
    ...
    <!-- Modal for Accept Reject template -->
    <div class="modal fade" id="reviewStatusModel" tabindex="-1" role="dialog" aria-labelledby="reviewStatusModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="productsDeleteModelLabel">Confirmation</h5>
                ...
                <div class="modal-body">
                    ...
                    <p class="mb-0" id="message_action"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" id="actionReview">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{asset('public/assets/js/reviews/reviews.js')}}"></script>
<script src="{{asset('public/assets/custom/star-rating/js/star-rating.js')}}"></script>
<script>
