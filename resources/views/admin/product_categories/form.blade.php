...
<title><?php echo $model->id ? 'Edit Product Category | '.config('app.name_show') : 'Add Product Category | '.config('app.name_show'); ?></title>
@section('content')
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{url(config('app.adminPrefix').'/product-category/index')}}">
                                                    List</a>
                                            </li>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Product Category INFORMATION</h5>
                        @if ($errors->any())
                        ...
                        <?php
                        if ($model->id)
                            $actionUrl = url(config('app.adminPrefix').'/product-category/update', $model->id);
                        else
                            $actionUrl = url(config('app.adminPrefix').'/product-category/store');
                        ?>
                        {{ Form::open(array('url' => $actionUrl,'class'=>'','id'=>'addProductCategoryForm','autocomplete'=>'off','enctype'=>"multipart/form-data")) }}
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
