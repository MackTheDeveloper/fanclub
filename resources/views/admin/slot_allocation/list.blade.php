        ...
        <div class="app-main__outer" style="width: 100%;">
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="{{url(config('app.adminPrefix').'/slotAllocations/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Slot</button></a>
                            </div>
                            <!-- <div class="d-inline-block dropdown">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                    <h5 class="card-title">List Of Slot Allocations</h5>
...
@push('scripts')
<script src="{{asset('public/assets/custom/datatables/location-management/slot-allocation-list-datatable.js')}}"></script>
<script>
