...
<title>{{config('app.name_show')}} | Home Page Components </title>
            ...
            <div class="app-main__inner">
                <div class="app-page-title app-page-title-simple">
                    <div class="page-title-wrapper">
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="javascript:void(0);" style="color: grey">Home Page Components</a>
                                            </li>
                        ...
                        @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_homepage_component_add') === true)

                            <div class="d-inline-block dropdown" >
                                <a href="{{url(config('app.adminPrefix').'/homepage-component/create')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add</button></a>
                            </div>
                            ...
                            <form method="post" class="form-inline">
                                ...
                                <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                    ...
                                    <select name="type" id="type" class="multiselect-dropdown form-control" style="width: 150px;">
                                        ...
                                        <option value="3">Dynamic Groups</option>
                                    </select>
                                </div>
                                <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                ...
                                <button type="button" id="search_homepage_comp" class="btn btn-primary">Search</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<!-- Modal for activating deactivating template -->
    <div class="modal fade" id="IsActiveModel" tabindex="-1" role="dialog" aria-labelledby="IsActiveModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="IsActiveModelLabel">Confirmation</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="IsActive">Yes</button>
                </div>
            </div>
        </div>
    </div>
