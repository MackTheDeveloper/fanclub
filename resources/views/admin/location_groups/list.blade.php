        ...
        <div class="app-main__outer" style="width: 100%;">
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="{{url(config('app.adminPrefix').'/locationGroups/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Location Group</button></a>
                            </div>
                        </div>
                        <div class="d-none">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                    <h5 class="card-title">List Of Location Groups</h5>
...
@push('scripts')
<script src="{{asset('public/assets/custom/datatables/location-management/location-groups-list-datatable.js')}}"></script>
<script>
