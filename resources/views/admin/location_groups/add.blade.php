...
@endphp
@section('title','Add Location Groups')
@section('content')
    <style type="text/css">
        .inputGroup input{
            width: 91%;
	...
	<div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <form id="addNewrecord" method="post" action="{{url(config('app.adminPrefix').'/locationGroups/add')}}">
                @csrf                                                          
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Enter Group name" value="{{ old('group_name') }}" />                                        
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" name="add_role" value="add_role">Add Location Group</button>
...
@push('scripts')
{{-- <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDq0nvwAdEsYBQVaPWkimfS13ssBOwgPho&libraries=places&callback=initialize" async></script> --}}
