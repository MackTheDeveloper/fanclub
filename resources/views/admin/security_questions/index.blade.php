...
<title>{{config('app.name_show')}} | Security Questions </title>
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                          <div class="d-inline-block dropdown" >
                            ...
                            @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_security_question_add') === true)
                            <div class="d-inline-block dropdown">
                                <a href="{{url(config('app.adminPrefix').'/security-questions/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Security Question</button></a>
                            </div>
                            @endif                            
                        </div>
                    </div>
