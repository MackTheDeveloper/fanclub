...
<title>{{config('app.name_show')}} | How It Works App </title>
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                          <div class="d-inline-block dropdown" >
                            ...
                            @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_how_it_works_app_add') === true)
                            <div class="d-inline-block dropdown">
                                <a href="{{url(config('app.adminPrefix').'/how-it-works-app/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add How It Works</button></a>
                            </div>
                            @endif                            
                        </div>
                    </div>
