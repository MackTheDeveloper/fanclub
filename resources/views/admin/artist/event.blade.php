...
<title>{{config('app.name_show')}} | Events </title>
                                    ...
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active breadcrumb-item" aria-current="page">
                                               <a style="color: slategray">{{$model->firstname}}'s Events</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                        ...
                        <table id="Tdatatable" class="display nowrap table table-hover table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr class="{{$row->status?"":"row_inactive"}}">
                                    ...
                                    <td class="text-center"><img src="{{$row->banner_image}}" alt="" width="50" height="50"></td>
