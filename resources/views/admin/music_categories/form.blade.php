...
<title><?php echo $model->id ? 'Edit Music Category | '.config('app.name_show') : 'Add Music Category | '.config('app.name_show'); ?></title>
@section('content')
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{url(config('app.adminPrefix').'/music-categories/index')}}" style="color: grey">
                                                    List</a>
                                            </li>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Music Category INFORMATION</h5>
                        @if ($errors->any())
                        ...
                        <?php
                        if ($model->id)
                            $actionUrl = url(config('app.adminPrefix').'/music-categories/update', $model->id);
                        else
                            $actionUrl = url(config('app.adminPrefix').'/music-categories/store');
                        ?>
                        <form id="addMusicCategoryForm" enctype="multipart/form-data" class="" method="post" action="{{$actionUrl}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <small class="form-text text-muted">Image size should be {{config('app.musicCategoryIconDimension.width')}} X {{config('app.musicCategoryIconDimension.height')}} px.</small>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ url(config('app.adminPrefix').'/music-categories/index') }}">
