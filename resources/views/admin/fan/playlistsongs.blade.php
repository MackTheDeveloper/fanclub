                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">Playlist's Songs</span>
                                </div>
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{ url(config('app.adminPrefix').'/fans/playlist/'.$model->user_id) }}" style="color: grey">Playlist</a>
                                            </li>
                                            <li class="active breadcrumb-item" aria-current="page">
                                               <a style="color: slategray">{{$model->playlist_name}}'s Songs of {{$model2->firstname}}'s Playlist</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
...
@section('modals-content')
    ...
    <div class="modal fade" id="fanPlaylistSongDeleteModel" tabindex="-1" role="dialog" aria-labelledby="fanPlaylistSongDeleteModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="fanPlaylistSongDeleteModelLabel">Confirmation</h5>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="fan_playlist_song_id" id="fan_playlist_song_id">
                    <p class="mb-0" id="message_delete"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" id="deletefanPlaylistSong">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
<script src="{{asset('public/assets/js/users/fanPlaylistSong.js')}}"></script>
<script>
