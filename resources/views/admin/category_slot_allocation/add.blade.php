...
@section('title','Slot Allocations')
	...
	<div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{url(config('app.adminPrefix').'/categorySlotAllocations/list')}}">List</a>
                                            </li>
                ...
                <form id="addNewrecord" method="post" action="{{url(config('app.adminPrefix').'/categorySlotAllocations/add')}}">
                @csrf                                                          
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <?php
                                                $location_group_id = empty(old('location_group_id'))?[]:old('location_group_id'); 
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                echo Form::select('category_id', $categories, $category_id, ['class' => 'form-control multiselect-dropdown','placeholder'=>'Select ...','id'=>'category_id']); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $ad_hero = old('ad_hero'); 
                                            echo Form::select('ad_hero', [], $ad_hero, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $ad_hero_start_date = old('ad_hero_start_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $ad_hero_end_date = old('ad_hero_end_date');
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_1 = empty(old('location_hero_1'))?[]:old('location_hero_1'); 
                                            echo Form::select('location_hero_1', [], $location_hero_1, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_1_start_date = old('location_hero_1_start_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_1_end_date = old('location_hero_1_end_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_1_cost = old('location_hero_1_cost');
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_2 = empty(old('location_hero_2'))?[]:old('location_hero_2'); 
                                            echo Form::select('location_hero_2', [], $location_hero_2, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_2_start_date = old('location_hero_2_start_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_2_end_date = old('location_hero_1_end_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_2_cost = old('location_hero_2_cost');
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_3 = empty(old('location_hero_3'))?[]:old('location_hero_3'); 
                                            echo Form::select('location_hero_3', [], $location_hero_3, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_3_start_date = old('location_hero_3_start_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_3_end_date = old('location_hero_1_end_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_3_cost = old('location_hero_3_cost');
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_4 = empty(old('location_hero_4'))?[]:old('location_hero_4'); 
                                            echo Form::select('location_hero_4', [], $location_hero_4, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_4_start_date = old('location_hero_4_start_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_4_end_date = old('location_hero_4_end_date');
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <?php
                                            $location_hero_4_cost = old('location_hero_4_cost');
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <a href="{{url(config('app.adminPrefix').'/categorySlotAllocations/list')}}"><button type="button" class="btn btn-light" name="cancel" value="Cancel">Cancel</button></a>
                            </div>
                        </div>
                    </div>
                </form>     
...
$(document).ready(function(){
    ...
    $("#addNewrecord").validate( {
        ...
        errorPlacement: function ( error, element ) {
            ...
            // console.log(element.hasClass('multiselect-dropdown'),element)
...
$(document).on("change","#category_id",function(){
    ...
    $.ajax({
        url:'{{ url("/securefcbcontrol/professional/bycateory") }}',
        method:'post',
        data:'category_id='+category_id+'&_token={{ csrf_token() }}',
        success:function(e){
            var options = ''
            for(var i=0;i<e.length;i++){
                options += '<option value="'+e[i].user_id+'">'+e[i].company_name+'</option>';
            }
            $('.professionalSelection').html(options);
        }
    })
})   
</script>
