...
@section('title','Category Slot Allocations')
@section('content')
        ...
        <div class="app-main__outer" style="width: 100%;">
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="{{url(config('app.adminPrefix').'/categorySlotAllocations/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Category Slot</button></a>
                            </div>
                            <!-- <div class="d-inline-block dropdown">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <form method="post" class="form-inline">  
                                ...
                                <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                    <label for="location_group_id" class="mr-sm-2">Contract Date</label>
                                    <input type="text" class="form-control" name="daterange" id="daterange" />
                                </div>
                                <div class="form-group mr-2">
                                    <label for="location_group_id" class="mr-sm-2">Location Group</label>
                                    <?php echo Form::select('location_group_id', $locationGroups, '', ['class' => 'form-control multiselect-dropdown', 'placeholder' => 'Select ...', 'id' => 'location_group_id']); ?>
                                </div>
                                <div class="form-group mr-2">
                                    <label for="category_id" class="mr-sm-2">Category</label>
                                    <?php echo Form::select('category_id', $categories, '', ['class' => 'form-control multiselect-dropdown', 'placeholder' => 'Select ...', 'id' => 'category_id']); ?>
                                </div>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                    <h5 class="card-title">List Of Category Slot Allocations</h5>
...
@push('scripts')
<script src="{{asset('public/assets/custom/datatables/location-management/category-slot-allocation-list-datatable.js')}}"></script>
<script>
