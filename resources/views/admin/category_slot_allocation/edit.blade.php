...
@section('title','Edit Category Slot Allocations')
@section('content')
	...
	<div class="app-main">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                        ...
                        <div class="page-title-heading">                            
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">Category Slot Allocations</span>
                                </div>
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="javascript:void(0)">Category Slot Allocations</a>
                                            </li>
                                            <li class="breadcrumb-item">
                ...
                <form id="addNewrecord" method="post" action="{{url(config('app.adminPrefix').'/categorySlotAllocations/update')}}" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <?php
                                                $category_id = empty(old('category_id'))?$model->category_id:old('category_id'); 
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            echo Form::select('ad_hero', $professionals, $ad_hero, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            echo Form::select('location_hero_1', $professionals, $location_hero_1, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            echo Form::select('location_hero_2', $professionals, $location_hero_2, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            echo Form::select('location_hero_3', $professionals, $location_hero_3, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            echo Form::select('location_hero_4', $professionals, $location_hero_4, ['class' => 'form-control multiselect-dropdown professionalSelection','placeholder' => 'Select ...']); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
