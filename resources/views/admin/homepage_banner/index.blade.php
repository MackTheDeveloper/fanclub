                        ...
                        @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_music_genres_add') === true)
                            <div class="page-title-actions">
                                <div class="d-inline-block dropdown">
                                    <a href="{{url(config('app.adminPrefix').'/homepagebanner/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add HomePage Banner</button></a>
                                </div>
                            </div>
                        @endif
                    </div>
