...
<title><?php echo $model->id ? 'Edit How It Works | '.config('app.name_show') : 'Add How It Works | '.config('app.name_show'); ?></title>
@section('content')
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="javascript:void(0);" style="color: grey">How It Works</a>
                                            </li>
                                            <li class="breadcrumb-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        {{-- <?php echo Form::text('title', $model->title, ['class' => 'form-control']); ?> --}}
                                        <?php echo Form::radio('type', 'fan', ($model->type && $model->type=='fan')?true:false); ?> Fan
                                        <?php echo Form::radio('type', 'artist', ($model->type && $model->type=='artist')?true:false); ?> Artist
                                    </div>
                                </div>
                            </div>
                        </div>
