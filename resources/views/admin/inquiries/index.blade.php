                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="javascript:void(0);">Product Enquiries</a>
                                            </li>
                ...
                <div class="main-card mb-3 card expand_filter" style="display:none;">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                <label for="category_id" class="mr-sm-2">Products</label>
                                <?php echo Form::select('category_id', $products, '', ['class' => 'form-control ', 'placeholder' => 'Select Product', 'id' => 'category_id']); ?>
                            </div>
                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
...
<script src="{{asset('public/assets/js/inquiries/inquiries.js')}}"></script>
<script>
