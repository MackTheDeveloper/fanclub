...
<title><?php echo $model->id ? 'Update Product | '.config('app.name_show') : 'Add Product | '.config('app.name_show'); ?></title>
@section('content')
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                                    ...
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active breadcrumb-item" aria-current="page">
                                                <?php echo $model->id ? 'Update' : 'Add'; ?> Product
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $model->id ? 'Update' : 'Add'; ?> Product</h5>
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php if (isset($model->id)) { ?>
                                    <div class="col-md-2" style="float: left"><a href="{{url('public/assets/images/product_image/' . $model->main_image)}}" target="_blank"><img src="{{url('public/assets/images/product_image/' . $model->main_image)}}" width="50" height="50" alt="" /></a></div>
                                <?php } ?>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <?php if (isset($otherImages) && !empty($otherImages)) { ?>
                                    ...
                                    <div class="col-md-2" style="float: left"><a href="{{url('public/assets/images/product_other_image/' . $otherImage)}}" target="_blank"><img src="{{url('public/assets/images/product_other_image/' . $otherImage)}}" width="50" height="50" alt="" /></a></div>
                                    @endforeach
                                <?php } ?>
                            </div>
                        </div>
