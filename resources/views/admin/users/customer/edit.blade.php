...
$(document).ready(function(){        
    ...
    $('#country').on('change', function(){
        ...
        $.ajax({
            url:'/securefcbcontrol/customer/states/' + country,
            method: "GET",
    ...
    $('#states').on('change', function(){
        var cities = $(this).val();        
        $.ajax({
            url:'/securefcbcontrol/customer/cities/' + cities,
            method: "GET",
            success: function(response) {
                if(response)
                {                    
    ...
    $('#customerDeleteAddress').click(function(){
        ...
        $.ajax({
            url:'/securefcbcontrol/customer/address/delete/' + address_id,
            method: 'GET',
            success: function(response)
            {                                
                ...
                {                                        
                    ...
                    if(response.address_arr.length > 0)
                    {
                        $.each(response.address_arr, function(i, v){                            
                            ...
                            output += '<div>'
                            output += '<a href="'+window.location.origin+'/securefcbcontrol/customer/address/edit/'+v.address_id+'"><button class="mb-2 mr-2 btn btn-shadow btn-outline-primary">Edit</button></a>'
