...
<title>Edit Locale | fanclub</title>
            ...
            <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        @endif
                        <form id="localeForm" class="col-md-12" method="POST" action="{{url(config('app.adminPrefix').'/locale/update')}}">
                            @csrf
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab-eg115-<?php echo $counter; ?>"
                                                    ...
                                                    <textarea type="text" dir="ltr" required id="locale_textarea"
                                                        name="test[{{$language->alpha2}},{{$language->id}},{{$language->language_id}}]"
                                                        cols="100" rows="5"
                                                        class="form-control">{{$language->value}}</textarea>
                                                </div>
                                                <?php }else{ ?>
