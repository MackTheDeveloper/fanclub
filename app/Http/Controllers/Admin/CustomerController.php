...
class CustomerController extends Controller
{
    ...
    public function getCustomerList(Request $request)
    {
        if($request->ajax()) {
            try {
                ...
                $customers = \App\Models\Customer::select('customers.id', 'customers.customer_unique_id','customers.first_name', 'customers.last_name', 'customers.mobile', 'customers.email',
        ...
        return view('admin.users.customer.list');
    }
    ...
    */ ###########################################
    public function updateAccountCustomer(Request $request)
    {
        ...
        return redirect(config('app.adminPrefix').'/customer/list')->with($notification);
    }
    ...
    */ ###########################################
    ...
    {
        // try{
            return Excel::download(new CustomersExport, 'fanclub_Customers.xlsx');
        // } catch(\Exception $ex) {
        //     return view('errors.500');
        // }
    }
    ...
    */ ###########################################
    public function addCustomerAddress(Request $request)
    {
        ...
        if($cust_address->save())
        {
            ...
            return redirect(config('app.adminPrefix').'/customer/edit/'.$request->customer_id.'#tab-address')->with(['tab' => '#tab-address']);
        }
        else
        {
