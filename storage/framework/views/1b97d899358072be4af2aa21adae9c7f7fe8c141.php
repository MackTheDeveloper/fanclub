...
<div class="fanclub-playlist section" id="<?php echo e($data->componentSlug); ?>">
    <div class="container-fluid">
        <div class="slider-header">
            ...
            <?php if($data->componentDynamicGroup->commonDetails->viewAll &&
                ...
                <?php if($data->componentDynamicGroup->commonDetails->groupType == 1): ?>
                    <a href="<?php echo e(route('allArtists')); ?>" class="a">See All</a>
                <?php elseif($data->componentDynamicGroup->commonDetails->groupType == 2): ?>
                    <a href="<?php echo e(route('allSongs')); ?>" class="a">See All</a>
...
<?php /**PATH /var/www/html/php/fanclub/resources/views/frontend/homepage-component/square.blade.php ENDPATH**/ ?>