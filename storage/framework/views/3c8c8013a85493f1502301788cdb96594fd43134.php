...
<script src="<?php echo e(asset('public/assets/frontend/js/bootstrap.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/frontend/js/script.js')); ?>?r=20220316"></script>
<script src="<?php echo e(asset('public/assets/frontend/js/developer.js')); ?>?r=20220316"></script>
<script src="<?php echo e(asset('public/assets/frontend/js/blockUI.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/frontend/js/choices.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/frontend/js/bootstrap-tagsinput.min.js')); ?>"></script>
...
<script type="text/javascript">
    ...
    $(document).on('submit', '#searchFront,#searchFront2', function(e) {
        ...
        window.location.href = "<?php echo e(url('search')); ?>/" + search;
    });
    ...
    $(document).on('change', '.artistLikeDislike', function() {
        ...
        if (artistId) {
            $.ajax({
                url: "<?php echo e(route('artistLikeDislike')); ?>",
                method: 'post',
                data: 'artist_id=' + artistId + '&_token=<?php echo e(csrf_token()); ?>',
    ...
    $(document).on('click', '#removerecent', function() {
        ...
        if (fansearchId) {
            $.ajax({
                url: "<?php echo e(route('fanSearchTagRemove')); ?>",
                method: 'post',
                data: 'fansearchId=' + fansearchId + '&_token=<?php echo e(csrf_token()); ?>',
                success: function(response) {
                    ...
                    $.each(response.component.recentSearchListData.recentSearchdata, function(k,
                        ...
                        $(".search-wrapper").append(
                            ...
                            .id +
                            '"><img src="<?php echo e(asset('public/assets/frontend/img/close-small.svg')); ?>" alt="" /></a></div>'
                        );
                    });
                }
            })
    ...
    $(document).on('click', '#searchtag', function() {
        ...
        if (searchTag) {
            ...
            window.location.href = "<?php echo e(url('search')); ?>/" + searchTag;
        }
    });
    $(document).on('change', '.songLikeDislike', function() {
        ...
        if (songId) {
            $.ajax({
                url: "<?php echo e(route('songLikeDislike')); ?>",
                method: 'post',
                data: 'song_id=' + songId + '&_token=<?php echo e(csrf_token()); ?>',
                success: function(response) {
                    toastr.clear();
                    toastr.options.closeButton = true;
                    toastr.success(response.message);
    ...
    $(document).on('change', '.groupLikeDislike', function() {
        ...
        if (groupId) {
            $.ajax({
                url: "<?php echo e(route('groupLikeDislike')); ?>",
                method: 'post',
                data: 'group_id=' + groupId + '&_token=<?php echo e(csrf_token()); ?>',
                success: function(response) {
                    toastr.clear();
                    toastr.options.closeButton = true;
                    toastr.success(response.message);
    ...
    function darkLightToggle(thhemeType) {
        ...
        $.ajax({
            url: "<?php echo e(route('themeToggle')); ?>",
            method: 'post',
            data: 'theme=' + thhemeType + '&_token=<?php echo e(csrf_token()); ?>',
            success: function(response) {
    ...
    $(document).on('change', '.allow-message-checkbox', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('allowMessage')); ?>",
            method: 'post',
            data: 'allowMessage=' + allowMessage + '&_token=<?php echo e(csrf_token()); ?>',
            success: function(response) {
                toastr.clear();
                toastr.options.closeButton = true;
                toastr.success(response.message);
...
<?php /**PATH /var/www/html/php/fanclub/resources/views/frontend/include/bottom.blade.php ENDPATH**/ ?>